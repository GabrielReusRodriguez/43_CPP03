...
/*   Updated: 2024/08/05 22:16:36 by gabriel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	this->_name= name;
	this->_energy_points = CLAPTRAP_DEFAULT_ENERGYPOINTS;
	this->_hit_points = CLAPTRAP_DEFAULT_HITPOINTS;
	this->_attack_damage = CLAPTRAP_DEFAULT_ATTACKDAMAGE;
